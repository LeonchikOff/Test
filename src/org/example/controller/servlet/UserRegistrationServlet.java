...
@WebServlet(RoutingUtil.UrlConstants.REGISTRATION)
public class UserRegistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        CreateUserTransfer createUserTransfer = CreateUserTransfer.builder()
                ...
                .build();
        try {
            if (userService.createUserAndGetId(createUserTransfer) != null)
